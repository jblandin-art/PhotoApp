...
const User = require("../../lib/schema/user.js");
const Photo = require("../../lib/schema/photo.js");
const SchemaInfo = require("../../lib/schema/schemaInfo.js");
...
export default async function handler(req, res) {
  ...
  console.log("[handler] rewritten url:", req.url);
